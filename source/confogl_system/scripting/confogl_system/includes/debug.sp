...
void Debug_OnModuleStart()
{
	...
	FormatEx(sBuffer, sizeof(sBuffer), "logs/confogl_system/errors_%s.log", sTime); //errors_20211201.log
	BuildPath(Path_SM, g_sLogAction, sizeof(g_sLogAction), sBuffer);

	BuildPath(Path_SM, sBuffer, sizeof(sBuffer), "logs/confogl_system");
