...
{
	g_hCvarDebugConVar = CreateConVar("confoglcompmod_debug", "0", "Turn on debug logging in all confogl modules", _, true, 0.0, true, 1.0);
	//confogl_custom_error_logs
	g_hCvarCustomErrorLog = CreateConVar( \
		"confoglcompmod_custom_error_logs", \
		"1", \
