					...
					else
					{
						...
						else
						{
							switch (itemNum)
							{
								case 1: 
								{
									if (CreateZombie(ZOMBIE_SHAMBLER, fPos, _, _, _, _, _, _, _, _, _, view_as<bool>(GetRandomInt(0, 1)), view_as<bool>(GetRandomInt(0, 1))) == INVALID_ENT_REFERENCE)
									{
								...
								case 2:
								{
									if (CreateZombie(ZOMBIE_RUNNER, fPos, _, _, _, _, _, _, _, _, _, view_as<bool>(GetRandomInt(0, 1)), view_as<bool>(GetRandomInt(0, 1))) == INVALID_ENT_REFERENCE)
									{
