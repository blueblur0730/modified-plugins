...
public Plugin myinfo =
{
	...
	description = "Finds the owner of convars generated by SourceMod. (An alternative version of dump_all_cmds_cvars by Bacardi)",
	version = PL_VERSION,
...
public void OnPluginStart()
{
	...
	BuildPath(Path_SM, g_sIgnorePath, sizeof(g_sIgnorePath), DUMP_PATH_CONVAR);
